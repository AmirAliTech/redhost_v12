...
<section class="breadcrumb-area bg-primary-gradient">
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="vps-about-item d-flex align-items-center flex-column flex-sm-row bg-white deep-shadow position-relative zindex-1 overflow-hidden">
                            <img src="assets/img/shapes/vps-about-shape.png" alt="not found" class="position-absolute right-bottom">
                       ...
                       <ul>
                        <li class="py-2" ><strong>SC EUROWEB SRL
    </strong></li>
                       <li class="py-2"><strong>Fiscal code:</strong> RO22621599</li>
                       <li><strong>Reg Com:  
</strong>J17/1826/2007</li>
                       <li class="py-2"><strong>Share capital: 
</strong> 200 lei</li>
                       <li class="py-2"><strong>Registered office:
</strong> Gradina Veche, 88</li>
                       <li class="py-2"><strong>City:</strong> Galati</li>
                       <li class="py-2"><strong>County:</strong> Galati</li>
                       <li class="py-2"><strong>Postal code:</strong> 800142</li>
                                </ul>
                            </div>
                        </div>
                    </div>
 ...
 <p class=" my-4 fw-bold text-uppercase" ><strong>For cash payments
</strong></p>
                       <ul>
                        <li><strong>BRD Agency Piata Mare
Account: SV32065501800
    </strong></li>
                
                                </ul>
 
 
 <p class=" my-4 fw-bold text-uppercase" ><strong>For payments with Payment Order
(transfer)
</strong></p>
                       <ul>
                        <li><strong>GarantiBank Galati
    </strong></li>
    <li><strong>RO25 UGBI 0000 1520 0642 4RON
</strong></li>
                
                                </ul>
 <p class=" my-4 fw-bold text-uppercase" ><strong>Treasury of the Municipality of Galati

</strong></p>
                       <ul>
                        <li><strong>(exclusively for budgetary institutions)

    </strong></li>
    <li><strong>RO65 TREZ 3065 069X XX00 9358
        ...
        <section class="hm-contact-area position-relative pt-60 pb-120 overflow-hidden bg-white zindex-1 " style="background-color: whitesmoke;">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="hm-ct-info-wrapper rounded">
                                ...
                                <div class="info-content mt-4">
                                    <h4>Email</h4>
                                    <span><a href="mailto:office@redhost.ro">office@redhost.ro</a></span>
                                </div>
                            </div>
                            <div class="hm-ct-info-wrapper rounded">
                                <span class="icon-wrapper rounded-circle d-inline-flex align-items-center justify-content-center">
                                ...
                                <div class="info-content mt-4">
                                    <h4>phone</h4>
                                    <div>
                                    <span><a href="tel:0236418473">0236/418.473</a> (Monday - Friday: 09:00-17:00)</span>
                                    </div>
                                    <span><a href="tel:0748030656">0748/030.656</a> (Monday - Friday: 09:00-17:00)</span>
