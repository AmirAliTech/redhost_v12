<footer class="footer ">
    <img src="assets/img/footer-layer.svg" alt="curve shape" class="w-100 " style="top: 30px; position:relative;">

    <div class="h5-footer position-relative z-index-1 overflow-hidden">

        <div class="container position-relative " style="z-index: 22;">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-widget footer-widget-1">
                        <a href="index.php" class="footer-logo"><img src="assets/img/logo-white.png" class="" style="max-width: 200px;" alt="logo"></a>
                        <!-- <p class=" mt-30">My service is not something I even think about because it is always there as we agreed. The customer service is responsive and knowledge needs for</p> -->
                        <div class="footer-social mt-5">
                            <ul class="social-nav mt-3">
                                <li><a href="#" class="rounded-circle overflow-hidden position-relative d-flex align-items-center justify-content-center "><i class="fab text-white fa-facebook-f"></i></a></li>
                                <li><a href="#" class="rounded-circle overflow-hidden position-relative d-flex align-items-center justify-content-center "><i class="fab text-white fa-twitter"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3  col-sm-6">
                    <div class="footer-widget footer-widget-2 mt-2">
                        <h5 class=" position-relative mb-5 widget-title">Quick Links</h5>
                        <ul class="footer-nav">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-widget footer-widget-3 mt-2">
                        <h5 class=" position-relative mb-5 widget-title">Servicii</h5>
                        <ul class="footer-nav">
                            <li class="d-flex">
                                <a href="gazduire-web-ssd.php"><span class="pe-2"><svg style="width: 30px;" preserveAspectRatio="xMinYMin meet" viewBox="0 0 32.36 32.36">
                                            <g data-name="Layer 2">
                                                <g>
                ...
                <div class="col-lg-3  col-sm-6">
                    <div class="footer-widget footer-widget-3 mt-2">
                        ...
                        <h5 class=" position-relative mb-5 widget-title">Contact Info</h5>
                        <ul class="contac-1">
                            <li>
                                ...
                                <div class="text">
                                    ...
                                    <p><strong style="color:#E81F30;">ABC City, Country</strong></p>
                                </div>
                            </li>
                            <li>
        ...
        <div class="row my-2">
            <div class="d-flex top-bottom-gap align-items-center justify-content-center flex-column flex-sm-row">

                <div class="image" style="max-width:300px">
                    <a href="https://anpc.ro/ce-este-sal/" target="_blank"><img class="w-100" src="./assets/img/redhostro.png" alt=""></a>
                </div>
                <div class="image" style="max-width:300px">
                    <a href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home.chooseLanguage" target="_blank"><img class="w-100" src="./assets/img/redhostro_1.png" alt=""></a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 text-center">
                    <p class=" m-0 py-2 copyright-txt  fw-800" style="color:#fff; font-weight:700;">Copyright
                        © 2023 By <a style="text-decoration: underline; color:#fff;" href="https://single-solution.com/">Single Solution</a>. All rights reserved. </p>
                </div>
...
<script src="./assets/js/vendors/dataTables.bootstrap5.min.js"></script>
<script src="./assets/js/vendors/dataTables.responsive.min.js"></script>
<script src="./assets/js/vendors/dataTables.buttons.min.js"></script>
<script src="./assets/js/vendors/datatables.init.js"></script>
